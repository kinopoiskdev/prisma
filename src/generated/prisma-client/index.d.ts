...
export namespace Prisma {
  ...
  */
  ...
  export interface MovieLogoDelegate<GlobalRejectSettings> {
   ...
   */
  export class Prisma__MovieLogoClient<T> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  export interface MovieNameItemDelegate<GlobalRejectSettings> {
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__MovieNameItemClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type MovieWatchabilityGetPayload<
    ...
    ? MovieWatchability  & {
    [P in TrueKeys<S['include']>]:
        P extends 'items' ? Array < MovieWatchabilityItemsGetPayload<S['include'][P]>>  :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'items' ? Array < MovieWatchabilityItemsGetPayload<S['select'][P]>>  :  P extends keyof MovieWatchability ? MovieWatchability[P] : never
  } 
    : MovieWatchability
  : MovieWatchability
  ...
  export interface MovieWatchabilityDelegate<GlobalRejectSettings> {
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__MovieWatchabilityClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
    ...
    items<T extends MovieWatchabilityItemsArgs = {}>(args?: Subset<T, MovieWatchabilityItemsArgs>): CheckSelect<T, PrismaPromise<Array<MovieWatchabilityItems>>, PrismaPromise<Array<MovieWatchabilityItemsGetPayload<T>>>>;
  ...
  export type MovieWatchabilityItemsGetPayload<
    ...
    ? MovieWatchabilityItems  & {
    [P in TrueKeys<S['include']>]:
        P extends 'logo' ? MovieLogoGetPayload<S['include'][P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'logo' ? MovieLogoGetPayload<S['select'][P]> :  P extends keyof MovieWatchabilityItems ? MovieWatchabilityItems[P] : never
  } 
    : MovieWatchabilityItems
  : MovieWatchabilityItems
  ...
  export interface MovieWatchabilityItemsDelegate<GlobalRejectSettings> {
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__MovieWatchabilityItemsClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export interface MovieReleaseYearsDelegate<GlobalRejectSettings> {
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__MovieReleaseYearsClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type MovieGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'genres' ? Array < MovieNameItemGetPayload<S['include'][P]>>  :
        P extends 'countries' ? Array < MovieNameItemGetPayload<S['include'][P]>>  :
        ...
        P extends 'watchability' ? MovieWatchabilityGetPayload<S['include'][P]> | null :
        P extends 'releaseYears' ? Array < MovieReleaseYearsGetPayload<S['include'][P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'genres' ? Array < MovieNameItemGetPayload<S['select'][P]>>  :
        P extends 'countries' ? Array < MovieNameItemGetPayload<S['select'][P]>>  :
        ...
        P extends 'watchability' ? MovieWatchabilityGetPayload<S['select'][P]> | null :
        P extends 'releaseYears' ? Array < MovieReleaseYearsGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__MovieClient<T> implements PrismaPromise<T> {
    ...
    genres<T extends MovieNameItemArgs = {}>(args?: Subset<T, MovieNameItemArgs>): CheckSelect<T, PrismaPromise<Array<MovieNameItem>>, PrismaPromise<Array<MovieNameItemGetPayload<T>>>>;

    countries<T extends MovieNameItemArgs = {}>(args?: Subset<T, MovieNameItemArgs>): CheckSelect<T, PrismaPromise<Array<MovieNameItem>>, PrismaPromise<Array<MovieNameItemGetPayload<T>>>>;
    ...
    releaseYears<T extends MovieReleaseYearsArgs = {}>(args?: Subset<T, MovieReleaseYearsArgs>): CheckSelect<T, PrismaPromise<Array<MovieReleaseYears>>, PrismaPromise<Array<MovieReleaseYearsGetPayload<T>>>>;
